...
public class AdminController {
    ...
    // 🟢 Render the attractive Admin Dashboard (videos.html)
    @GetMapping
    public String adminPage(Model model, @RequestParam(value = "hlsUrl", required = false) String hlsUrl) {
        ...
        return "admin"; // ✅ Updated from "admin" to new beautiful dashboard
    }
    ...
    public String upload(@RequestParam("file") MultipartFile file) {
        try {
            if (file.isEmpty()) {
                return "redirect:/admin?error=No+file+selected";
            }
    ...
    public String createUser(@RequestParam String username,
        ...
        try {
            ...
            e.printStackTrace();
            return "redirect:/admin?error=User+creation+failed";
        }
        return "redirect:/admin";
    }
    ...
    public String deleteUser(@RequestParam Long id) {
        try {
            ...
            e.printStackTrace();
            return "redirect:/admin?error=Delete+user+failed";
        }
        return "redirect:/admin";
    }

    // 🟢 Generate Signed HLS Token for Secure Video Access
    ...
    public String generateHlsToken(@RequestParam String videoId, Model model) {
        ...
        model.addAttribute("videos", videoService.listAll());
        model.addAttribute("users", userService.listAllUsers());
        return "videos"; // ✅ Updated from "admin"
    }
}
